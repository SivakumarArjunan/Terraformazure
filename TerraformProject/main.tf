...
#   name                         = "appserver7904890"
#   resource_group_name          = azurerm_resource_group.app_grp.name
#   location                     = var.location
#   version                      = "12.0"
#   administrator_login          = "terrasql"
#   administrator_login_password = "Terraform@123"
# }
# resource "azurerm_sql_database" "terradb" {
#   name                = "terradb"
#   resource_group_name = azurerm_resource_group.app_grp.name
#   location            = var.location
...
#   ]
# }
# resource "azurerm_sql_firewall_rule" "app_server" {
#   name                = "app-server-firewall-rule"
#   resource_group_name = azurerm_resource_group.app_grp.name
#   server_name         = azurerm_sql_server.app_server.name
#   start_ip_address    = "103.78.166.92"
#   end_ip_address      = "103.78.166.92"
#   depends_on  = [
#     azurerm_sql_server.app_server
#   ]
# }